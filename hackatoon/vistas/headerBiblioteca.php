...
<head>
    ...
    <link rel="stylesheet" href="css/card_dising01.css">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 py-5">
                    <h1 class="mb-4">Explora nuestra biblioteca</h1>
                    <h2 class="m-0">Una valiosa fuente de conocimient en salud y discapacidades físicas.

                    </h2>
                    <button class="btn btn-primary">Comienza a leer</button>
                </div>
                <div class="col-lg-5">
