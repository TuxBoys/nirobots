...
<head>
    ...
    <title>ADMINISTRACIÓN Ni.ROBOTS</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">ADMINISTRACIÓN <sup> Ni. Robots</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manejo de libros</h6>
                        <a class="collapse-item" href="eliminarLibros.php">Eliminar Libros</a>
                        <a class="collapse-item" href="incersionLibros.php">Insertar Libros</a>
                    </div>
                </div>
